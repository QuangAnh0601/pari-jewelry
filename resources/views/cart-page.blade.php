                                        ...
                                        @foreach ($products as $key => $product)
                                            @auth('customer')
                                                <tr class="cart__table--body__items">
                                                    <td class="cart__table--body__list">
                                                        <div class="cart__product d-flex align-items-center">
                                                            ...
                                                            <div class="cart__thumbnail">
                                                                <a href="/product-detail/show/{{ $product->id }}"><img class="border-radius-5" src="{{ asset('/img/product/small-product/product1.webp') }}" alt="cart-product"></a>
                                                            </div>
                                                    ...
                                                    <td class="cart__table--body__list">
                                                        <span class="cart__price">{{ number_format($product->price, 0 , '.', ',') }} VND</span>
                                                    </td>
                                                    <td class="cart__table--body__list">
                                                    ...
                                                    <td class="cart__table--body__list">
                                                        <span class="cart__price end">{{ number_format($product->pivot->quantity * $product->price, 0, '.', ',') }} VND</span>
                                                    </td>
                                                </tr>
                                            {{-- @else
                                                <tr class="cart__table--body__items">
                                                    <td class="cart__table--body__list">
                                                        <div class="cart__product d-flex align-items-center">
                                                            ...
                                                            <div class="cart__thumbnail">
                                                                <a href="/product-detail/show/{{ $key }}"><img class="border-radius-5" src="{{ asset('/img/product/small-product/product2.webp') }}" alt="cart-product"></a>
                                                            </div>
                                                            <div class="cart__content">
                                                                <h3 class="cart__content--title h4"><a href="/product-detail/show/{{ $key }}">{{ $product['product_name'] }} </a></h3>
                                                                <span class="cart__content--variant">MATERIAL: {{ $product['material'] }}</span>
                                                                <span class="cart__content--variant">WEIGHT: {{ $product['weight'] }}g</span>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <td class="cart__table--body__list">
                                                        <span class="cart__price end">{{ number_format($product['price'], 0, '.', ',') }} VND</span>
                                                    </td>
                                                </tr> --}}
                                            @endauth
                                        @endforeach
