        ...
        @foreach ($topRates as $rate)
            <div class="small__product--card d-flex">
                <div class="small__product--thumbnail">
                    <a class="display-block" href="/product-detail/show/{{ $rate->product->id }}"><img src="{{  asset('/product//'. $rate->product->getImage()) }}" alt="product-img"></a>
                </div>
                <div class="small__product--content">
                    <h3 class="small__product--card__title"><a href="/product-detail/show/{{ $rate->product->id }}">{{ $rate->product->name }}</a></h3>
                    <div class="small__product--card__price mb_5">
                        <span class="current__price">{{ number_format($rate->product->price, 0, '.', ',') }}</span>
                    </div>
