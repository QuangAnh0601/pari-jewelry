 ...
 <header class="header__section">
            ...
            <div class="header__topbar--inner style6 d-flex align-items-center justify-content-between">
                ...
                <div class="header__top--right d-flex align-items-center">
                    <ul class="language__currency d-flex align-items-center">
                        <li class="language__currency--list">
                            <a class="language__currency--link currency__link" href="javascript:void(0)">
                                <img class="currency__link--icon" src="{{ asset('/img/icon/language-icon.webp') }}" alt="currency">
                                <span>USD</span> 
                    ...
                    <ul class="header__top--link d-flex align-items-center">
                        <li class="header__link--menu"><a class="header__link--menu__text" href="/customer/wish-list">
            ...
            <div class="main__header--inner d-flex justify-content-between align-items-center">
                ...
                <div class="main__logo">
                    <h1 class="main__logo--title"><a class="main__logo--link" href="/">
                        <img class="main__logo--img" src="{{ asset('/img/logo/Pari.png') }}" width="60" alt="logo-img">
                    </a></h1>
                </div>
                    ...
                    <nav class="header__menu--navigation">
                        <ul class="header__menu--wrapper d-flex">
                            <li class="header__menu--items">
                                <a class="header__menu--link" href="/">Categry 
                                ...
                                <ul class="header__sub--menu">
                                    @foreach ($categories as $category)
                                        <li class="header__sub--menu__items"><a href="http://paris.jewelry.com/shop/sortByFilter?category_filter={{ $category->categoryLink() }}" class="header__sub--menu__link">{{ $category->name }}</a></li>
                                    ...
                                    <ul class="header__mega--menu d-flex">
                                        ...
                                        <li class="header__mega--menu__li">
                                            <ul class="header__mega--sub__menu">
                                                ...
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="customer/wish-list">Wishlist</a></li>
                                        ...
                                        <li class="header__mega--menu__li">
                                            <ul class="header__mega--sub__menu">
                                                ...
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="/static-page/contact">Contact Us</a></li>
                                        ...
                                        <li class="header__mega--menu__li banner__child">
                                            <div class="header__mega--menu__banner">
                                                <a href="shop.html">
                                                    <img class="header__mega--menu__banner--img" src="{{ asset('/img/banner/banner-menu.webp') }}" alt="banner">
                                                </a>
                                            </div>
                                        </li>
                                    </ul>
                            ...
                            {{-- <li class="header__menu--items">
                                ...
                                <ul class="header__sub--menu">
                                    ...
                                    <li class="header__sub--menu__items"><a href="/static-page/contact" class="header__sub--menu__link">Contact Us</a></li>
                                    ...
                                    <li class="header__sub--menu__items"><a href="customer/wish-list" class="header__sub--menu__link">Wishlist Page</a></li>
                            ...
                            <li class="header__menu--items">
                                <a class="header__menu--link" href="/static-page/contact">Contact </a>  
                            </li>
                        </ul>
                    </nav>
                </div>
                <div class="header__account">
                    <ul class="header__account--wrapper d-flex align-items-center">
                        ...
                        <li class="header__account--items">
                            <a class="header__account--btn d-sm-2-none" href="/customer/wish-list">
                                <span class="header__account--btn__icon">
                                    <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        @auth('customer')
                            <li class="header__account--items dropdown">
                                <a class="header__account--btn d-sm-2-none" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <span class="header__account--btn__icon">
                                        <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="customer/dashboard">My Page</a>
                        ...
                        @else
                            <li class="header__account--items">
                                <a class="header__account--btn d-sm-2-none" href="{{route('customer.login')}}">
                                    <span class="header__account--btn__icon">
                                        <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M16 16V14.3333C16 13.4493 15.6049 12.6014 14.9016 11.9763C14.1984 11.3512 13.2446 11 12.25 11H4.75C3.75544 11 2.80161 11.3512 2.09835 11.9763C1.39509 12.6014 1 13.4493 1 14.3333V16" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M8.5 7.66667C10.5711 7.66667 12.25 6.17428 12.25 4.33333C12.25 2.49238 10.5711 1 8.5 1C6.42893 1 4.75 2.49238 4.75 4.33333C4.75 6.17428 6.42893 7.66667 8.5 7.66667Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <li class="header__account--items header__minicart--items">
                            <a class="header__account--btn minicart__open--btn" href="javascript:void(0)" data-offcanvas>
                                ...
                                <span class="items__count">
                                    @auth('customer')
                                        {{ optional(auth('customer')->user())->cart->quantity ?? 0 }}
                                    @else
        ...
        <div class="offcanvas__inner">
            <div class="offcanvas__logo">
                <a class="offcanvas__logo_link" href="/">
                    <img src="{{ asset('/img/logo/nav-log.webp') }}" alt="Logo-img" width="158" height="36">
                </a>
                ...
                <ul class="offcanvas__menu_ul">
                    <li class="offcanvas__menu_li">
                        ...
                        <ul class="offcanvas__sub_menu">
                            @foreach ($categories as $category)
                                <li class="offcanvas__sub_menu_li"><a href="http://paris.jewelry.com/shop/sortByFilter?category_filter={{ $category->categoryLink() }}" class="offcanvas__sub_menu_item">{{ $category->name }}</a></li>
                            @endforeach
                        </ul>
                    </li>
                    <li class="offcanvas__menu_li">
                        ...
                        <ul class="offcanvas__sub_menu">
                            ...
                            <li class="offcanvas__sub_menu_li">
                                ...
                                <ul class="offcanvas__sub_menu">
                                    ...
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="/static-page/contact">Contact Us</a></li>
                    ...
                    <li class="offcanvas__menu_li">
                        ...
                        <ul class="offcanvas__sub_menu">
                            ...
                            <li class="offcanvas__sub_menu_li"><a href="/static-page/contact" class="offcanvas__sub_menu_item">Contact Us</a></li>
                            ...
                            <li class="offcanvas__sub_menu_li"><a href="/customer/wish-list" class="offcanvas__sub_menu_item">Wishlist Page</a></li>
                    ...
                    <li class="offcanvas__menu_li"><a class="offcanvas__menu_item" href="/static-page/contact">Contact</a></li>
                </ul>
    ...
    <div class="offcanvas__sticky--toolbar">
        <ul class="d-flex justify-content-between">
            ...
            <li class="offcanvas__sticky--toolbar__list">
                <a class="offcanvas__sticky--toolbar__btn" href="/customer/wish-list">
                    <span class="offcanvas__sticky--toolbar__icon"> 
                    ...
                    @auth('customer')
                        <span class="items__count">{{ optional(auth('customer')->user())->products->count() }}</span>
                    @endauth 
                </a>
            </li>
        </ul>
    ...
    <div class="offCanvas__minicart">
        ...
        <div class="minicart__product">
            @auth('customer')
                @isset(optional(auth('customer')->user())->cart->products)
                    @foreach ( optional(auth('customer')->user())->cart->products as $key => $value)
                        <div class="minicart__product--items product-{{ $value->id }} d-flex">
                            <div class="minicart__thumb">
                                <a href="/product-detail/show/{{ $value->id }}"><img src="{{ $value->productImages->first() ? asset( "/product//".$value->productImages->first()->file_name) : asset('/product/no-image.png') }}" alt="prduct-img"></a>
                            </div>
                            <div class="minicart__text">
                                <h4 class="minicart__subtitle"><a href="product-details.html">{{ $value->name }}</a></h4>
                                <span class="color__variant"><b>material:</b> {{ $value->material }}</span>
                                <div class="minicart__price">
                                    <span class="minicart__current--price">{{ number_format($value->price * $value->pivot->quantity, 0, '.', '') }} VND</span>
                                ...
                                <div class="minicart__text--footer d-flex align-items-center">
                                    <div class="quantity__box minicart__quantity">
                                        ...
                                        <label>
                                            <input type="number" data-product-id="{{ $value->id }}" class="quantity__number" value="{{ $value->pivot->quantity }}" data-counter />
                                        </label>
                                        <button type="button" class="quantity__value increase" aria-label="quantity value" value="Increase Value">+</button>
                                    </div>
                                    <button class="minicart__product--remove" data-product-id="{{ $value->id }}" type="button">Remove</button>
                                </div>
                            </div>
                        </div>
                    @endforeach
            ...
            @else
                @if (session()->has('cart'))
                    @foreach (session()->get('cart') as $key => $value)
                        <div class="minicart__product--items product-{{ $key }} d-flex">
                            <div class="minicart__thumb">
                                <a href="/product-detail/show/{{$key}}"><img src="{{ asset("/product//".$value['image']) }}" alt="prduct-img"></a>
                            </div>
                            <div class="minicart__text">
                                <h4 class="minicart__subtitle"><a href="product-details.html">{{ $value['product_name'] }}</a></h4>
                                <span class="color__variant"><b>material:</b> {{ $value['material'] }}</span>
                                <div class="minicart__price">
                                    <span class="minicart__current--price">{{ $value['total_price'] }} VND</span>
                                    {{-- <span class="minicart__old--price">$140.00</span> --}}
                                </div>
                                <div class="minicart__text--footer d-flex align-items-center">
                                    <div class="quantity__box minicart__quantity">
                                        <button type="button" class="quantity__value decrease" aria-label="quantity value" value="Decrease Value">-</button>
                                        <label>
                                            <input type="number" data-product-id="{{$key}}" class="quantity__number" value="{{ $value['quantity'] }}" data-counter />
                                        </label>
                                        <button type="button" class="quantity__value increase" aria-label="quantity value" value="Increase Value">+</button>
                                    </div>
        ...
        <div class="minicart__amount">
            <div class="minicart__amount_list d-flex justify-content-between">
                ...
                <span><b>
                    ...
                    @auth('customer')
                        @isset(optional(auth('customer')->user())->cart->products)
                            @foreach (optional(auth('customer')->user())->cart->products as $item)
                                @php
                    ...
                    @else
                        @if (session()->has('cart'))
                            @foreach (collect(session()->get('cart'))->pluck('total_price') as $item)
                                @php
                                    $totalPrice += $item
                                @endphp
                            @endforeach
    ...
    <div class="predictive__search--box ">
        <div class="predictive__search--box__inner">
            ...
            <form class="predictive__search--form" action="/shop/searchProduct">
                <label>
...
@push('customize-js')
    <script>
        $(document).ready(function () {
            $('.minicart__product').on('click', '.increase', function () { 
                console.log($(this));
                var currentTotalPrice = $(this).closest('.minicart__text--footer').prev().children()
                console.log(currentTotalPrice.html());
                var quantity = $(this).prev().children().val()
                var productId = $(this).prev().children().attr('data-product-id')
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        currentTotalPrice.text(response.total_price + " VND")
                    },
                    error: function (err) {
            ...
            $('.minicart__product').on('click', '.decrease', function () { 
                console.log($(this));
                var currentTotalPrice = $(this).closest('.minicart__text--footer').prev().children()
                console.log('aa',currentTotalPrice);
                var quantity = $(this).next().children().val()
                var productId = $(this).next().children().attr('data-product-id')
                console.log(quantity);
                $.ajaxSetup({
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            ...
            $('.minicart__product').on('click', '.quantity__number', function () { 
                var currentTotalPrice = $(this).closest('.minicart__text--footer').prev().children()
            ...
            $('.minicart__product').on('click', '.minicart__product--remove', function () { 
                var id = $(this).attr('data-product-id');
                var removeItem = $(this).closest('.minicart__text--footer').closest('.minicart__text').closest('.minicart__product--items')
                $.ajaxSetup({
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    }
            ...
            $('.wishlist__cart--btn').click(function () { 
                    var id = $(this).attr('data-product-id');
