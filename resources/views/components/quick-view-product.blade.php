                ...
                <div class="col">
                    <div class="quickview__gallery">
                        <div class="product__media--preview  swiper">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items myslide-1">
                                ...
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items myslide-2">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{ asset('/product/no-image.png') }}"><img class="product__media--preview__items--img" src="{{ asset('/product/no-image.png') }}" alt="product-media-img"></a>
                                        <div class="product__media--view__icon">
                                            <a class="product__media--view__icon--link glightbox" href="{{ asset('/product/no-image.png') }}" data-gallery="product-media-preview">
                                                <svg class="product__items--action__btn--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                ...
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items myslide-3">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{ asset('/product/no-image.png') }}"><img class="product__media--preview__items--img" src="{{ asset('/product/no-image.png') }}" alt="product-media-img"></a>
                                        <div class="product__media--view__icon">
                                            <a class="product__media--view__icon--link glightbox" href="{{ asset('/product/no-image.png') }}" data-gallery="product-media-preview">
                                                <svg class="product__items--action__btn--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                ...
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items myslide-4">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{ asset('/product/no-image.png') }}"><img class="product__media--preview__items--img" src="{{ asset('/product/no-image.png') }}" alt="product-media-img"></a>
                                        <div class="product__media--view__icon">
                                            <a class="product__media--view__icon--link glightbox" href="{{ asset('/product/no-image.png') }}" data-gallery="product-media-preview">
                                                <svg class="product__items--action__btn--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                ...
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items myslide-5">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{ asset('/product/no-image.png') }}"><img class="product__media--preview__items--img" src="{{ asset('/product/no-image.png') }}" alt="product-media-img"></a>
                                        <div class="product__media--view__icon">
                                            <a class="product__media--view__icon--link glightbox" href="{{ asset('/product/no-image.png') }}" data-gallery="product-media-preview">
                                                <svg class="product__items--action__btn--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                        ...
                        <div class="product__media--nav swiper">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="product__media--nav__items my_nav-1">
                                        <img class="product__media--nav__items--img" src="{{ asset('/product/no-image.png') }}" alt="product-nav-img">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="product__media--nav__items my_nav-2">
                                        <img class="product__media--nav__items--img" src="{{ asset('/product/no-image.png') }}" alt="product-nav-img">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="product__media--nav__items my_nav-3">
                                        <img class="product__media--nav__items--img" src="{{ asset('/product/no-image.png') }}" alt="product-nav-img">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="product__media--nav__items my_nav-4">
                                        <img class="product__media--nav__items--img" src="{{ asset('/product/no-image.png') }}" alt="product-nav-img">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="product__media--nav__items my_nav-5">
                                        <img class="product__media--nav__items--img" src="{{ asset('/product/no-image.png') }}" alt="product-nav-img">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="product__variant">
                                <div class="product__variant--list mb-20">
                                    <fieldset class="variant__input--fieldset">
                                        <legend class="product__variant--title materialModal mb-10">Material : silver</legend>
                                        {{-- <div class="variant__color d-flex">
                                            <div class="variant__color--list">
                                                <input id="color-red1" name="color" type="radio" checked>
                                                <label class="variant__color--value red" for="color-red1" title="Red"><img class="variant__color--value__img" src="{{ asset('/product/no-image.png') }}" alt="variant-color-img"></label>
                                            </div>
                                            <div class="variant__color--list">
                                                <input id="color-red2" name="color" type="radio">
                                                <label class="variant__color--value red" for="color-red2" title="Black"><img class="variant__color--value__img" src="{{ asset('/product/no-image.png') }}" alt="variant-color-img"></label>
                                            </div>
                                            <div class="variant__color--list">
                                                <input id="color-red3" name="color" type="radio">
                                                <label class="variant__color--value red" for="color-red3" title="Pink"><img class="variant__color--value__img" src="{{ asset('/product/no-image.png') }}" alt="variant-color-img"></label>
                                            </div>
                                            <div class="variant__color--list">
                                                <input id="color-red4" name="color" type="radio">
                                                <label class="variant__color--value red" for="color-red4" title="Orange"><img class="variant__color--value__img" src="{{ asset('/product/no-image.png') }}" alt="variant-color-img"></label>
                                            </div>
                                        </div> --}}
                                    </fieldset>
                                </div>
                                <div class="product__variant--list mb-20">
                                    <fieldset class="variant__input--fieldset">
                                        <legend class="product__variant--title weightModal mb-10">Weight : 20 g</legend>
                                ...
                                <div class="quickview__variant--list quantity d-flex align-items-center mb-15">
                                    ...
                                    <button data-product-id="" class="primary__btn quickview__cart--btn wishlist__cart--btn" type="button">Add To Cart</button>  
                                </div>
                                <div class="quickview__variant--list variant__wishlist mb-15">
                                    <a class="variant__wishlist--icon" href="javascript:void(0)" title="Add to wishlist"
                                    onclick="event.preventDefault();
                                    document.getElementById('wishlist-form-quick-view').submit();">
...
<form id="wishlist-form-quick-view" action="/" method="POST" class="d-none">
    @csrf
</form>
