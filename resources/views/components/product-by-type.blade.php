    ...
    <div class="container">
        <div class="row mb--n30">
                        ...
                        @foreach ($newestProducts as $product)
                            <article class="small__product--card d-flex align-items-center">
                                <div class="small__product--thumbnail">
                                    <a class="display-block" href="/product-detail/show/{{ $product->id }}"><img class="small__product--thumbnail__img" src="{{ asset('/product/'. $product->getImage()) }}" alt="img"></a>
                                </div>
            ...
            <div class="col-lg-4 col-md-6 mb-30">
                <div class="small__product--step">
                    <div class="section__heading mb-30">
                        <h2 class="section__heading--maintitle">Best sellers Products</h2>
                    </div>
                    <div class="small__product--step__inner">
