            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="about__thumbnail padding__left position-relative">
                        <img src="{{ asset('/img/other/pexels-abdullah-alsaibaie-16004293.jpg') }}" alt="img">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="about__content padding__left">
                        ...
                        <a class="about__conten--btn primary__btn" href="/static-page/about">VIEW MORE</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="team__container">
                    <div class="row mb--n30">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                            <div class="team__items text-center">
                                <div class="team__thumb">
                                    <img class="team__thumb--img" src="{{ asset('img/other/pexels-юлиана-маринина-9197291.jpg') }}" alt="team img">
                                </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                            <div class="team__items text-center">
                                <div class="team__thumb">
                                    <img class="team__thumb--img" src="{{ asset('img/other/pexels-shvets-production-7506904.jpg') }}" alt="team img">
                                </div>
                                <div class="team__content">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="brang__logo--items">
                                <img class="brang__logo--img" src="{{ asset('img/logo/tiffany.png') }}" alt="brand-logo">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brang__logo--items">
                                <img class="brang__logo--img" src="{{ asset('img/logo/cartier.jpg') }}" alt="brand-logo">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brang__logo--items">
                                <img class="brang__logo--img" src="{{ asset('img/logo/buccellati.svg') }}" alt="brand-logo">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brang__logo--items">
                                <img class="brang__logo--img" src="{{ asset('img/logo/hermes-logo.svg') }}" width="300" alt="brand-logo">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brang__logo--items">
                                <img class="brang__logo--img" src="{{ asset('img/logo/dior.webp') }}" alt="brand-logo">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brang__logo--items">
