            ...
            <ul class="pagination__wrapper d-flex align-items-center justify-content-center">
                @if ($paginator->onFirstPage())
                    <li class="pagination__list">
                        <a class="pagination__item--arrow  link disabled" aria-disabled="true">
                ...
                @if ($paginator->hasMorePages())
                    <li class="pagination__list">
                        <a href="{{ $paginator->nextPageUrl() }}" rel="next" class="pagination__item--arrow  link " aria-label="@lang('pagination.next')">
